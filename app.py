...
# #chatModel = ChatGoogleGenerativeAI(model="gemini-pro", temperature=0.3)
...
# ✅ FIX: pass document_variable_name="context"
...
def chat():
    ...
    # 🧩 Debug: Check what Pinecone returns
